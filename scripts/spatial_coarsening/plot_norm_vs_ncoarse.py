...
fig = plt.figure(1)
plt.plot(nsteps, norm_l2[0,:], 'bo-', label=f'm={str(ndof_c_v[0])}')
plt.plot(nsteps, norm_l2[1,:], 'rx-', label=f'm={str(ndof_c_v[1])}')
plt.plot(nsteps, norm_l2[2,:], 'cd-', label=f'm={str(ndof_c_v[2])}')
plt.plot(nsteps, norm_l2[3,:], 'k+-', label=f'm={str(ndof_c_v[3])}')
